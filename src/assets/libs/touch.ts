...
export default class {
   ...
   * @param {number} operationWrapperWidth the operator width
   */
   ...
   */
  touchMove(e: any) {
    const moveWidth = this.getMoveWidth(e);
  ...
  // 获取滑动过程中 滑动的宽度
  private getMoveWidth(e: any) {
    return this.getClientX(e) - this.startClientX;
  }
