...
declare namespace Behavior {
    ...
    interface BehaviorInstanceBaseProps<D extends IAnyObject = any> {
        /** 页面的初始数据
         *
    ...
    // https://developers.weixin.qq.com/miniprogram/dev/framework/custom-Behavior/lifetimes.html
    interface BehaviorInstance<D extends IAnyObject = any, T extends IAnyObject = any> extends BehaviorInstanceBaseProps<D> {
